...
class GS_Linear: 
    ...
    def solve_coefficients(self):
        ...
        if self.beta_limit == False:
            ...
            self.UH = np.concatenate(([self.BC1[0]], [self.BC2[0]],[self.BC3[0]],[self.BC4[0]], [self.BC5[0]], [self.BC6[0]], [self.BC7[0]],[self.BC8[0]]), axis=0) 
            self.UP = np.concatenate(([-1*self.BC1[1]], [-1*self.BC2[1]],[-1*self.BC3[1]],[-1*self.BC4[1]], [-1*self.BC5[1]], [-1*self.BC6[1]], [-1*self.BC7[1]],[-1*self.BC8[1]]), axis=0) 
    ...
    def get_BCs(self):
        ...
        if self.beta_limit == True:
            x,y = self.inner_point()
            self.BC8 = self.get_point_slope_dx(x,y) 
